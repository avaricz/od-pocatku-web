        ...
        ">
            ...
            ">
                <div class="absolute inset-0 flex rounded-md overflow-hidden">
                    <NuxtImg :src="image" class="w-full object-cover object-center" alt="" densities="1x" sizes="400px "
                        format="webp" quality="90" />
                </div>
                <div class="absolute inset-0  opacity-70 rounded-md " :class="overlayColor"></div>
                <h3 class="text-center z-10" :class="textColor,
                    { 'text-transparent': isActive && isMobile }">{{ title, isMobile }}</h3>
            </div>
            ...
            ">
                <div
                    class="absolute w-[260px] h-[260px] bg-[url('/flower.svg')] bg-no-repeat bg-left bg-cover opacity-[0.3] z-0 top-[-60px] right-[-80px]">
                </div>
                <div class="flex flex-1 items-center justify-center">

                    <ul class="flex flex-col gap-2 px-4 ">
                        <li v-for="item in description" class="flex items-start gap-2">
                            <div class="pt-1">
